...
0. **Urađeno (0.6.4, DECISIONS/0017):** vlasnik prihvatio prototip uz izmene — dobrodošlica pa odmah Danas, upitnik kao opcija, početni ekran samo jelovnik, bez mikrofona u aplikaciji. Vlasnik će dodati nove zahteve. **Sledeće:** razgovor o hrani i receptima, pa preslaganje prave aplikacije prema UI_SPEC.
   Ranije: vlasnik pregleda prototip (https://mera-app-test.github.io/prototip.html?v=061) i odlučuje o stavkama van obuhvata V1 (UI_SPEC, poslednji deo). Posle toga prava aplikacija se preslaže prema prototipu (upitnik 0.6.0 → koraci upitnika, GoalCard → zbir na Danas).
